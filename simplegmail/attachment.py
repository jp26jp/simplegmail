...
class Attachment(object):
    ...
    Args:
        ...
        message_id: The id of message the attachment belongs to.
    ...
    Attributes:
        ...
        message_id (str): The id of message the attachment belongs to.
    ...
    def download(self) -> None:
        ...
        res = self._service.users().messages().attachments().get(
            userId=self.user_id, messageId=self.message_id, id=self.id
        ).execute()
